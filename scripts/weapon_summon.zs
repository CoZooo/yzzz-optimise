...
<item:eidolon:bonelord_helm>.anyDamage().addGlobalAttributeModifier(<attribute:attributeslib:healing_received> , "attribute.bonelord_helm.4", 0.5, crafttweaker.api.entity.attribute.AttributeOperation.MULTIPLY_BASE, [<constant:minecraft:equipmentslot:head>]);
<item:eidolon:bonelord_chestplate>.anyDamage().addGlobalAttributeModifier(<attribute:attributeslib:healing_received> , "attribute.bonelord_chestplate.4", 0.5, crafttweaker.api.entity.attribute.AttributeOperation.MULTIPLY_BASE, [<constant:minecraft:equipmentslot:chest>]);
<item:eidolon:bonelord_greaves>.anyDamage().addGlobalAttributeModifier(<attribute:attributeslib:healing_received> , "attribute.bonelord_greaves.4", 0.5, crafttweaker.api.entity.attribute.AttributeOperation.MULTIPLY_BASE, [<constant:minecraft:equipmentslot:legs>]);
