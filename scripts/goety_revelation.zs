...
<item:goety_revelation:blessing_scroll>.anyDamage().addTooltip("\u00A7e为全伤害加成，并非只增加近战伤害，且为独立乘区加成");
...
<item:goety_revelation:dimensional_will>.addTooltip("\u00A7c维度意志可用「+100%效果加成的世界之魂」合成获得");
<item:goety_revelation:dimensional_will>.addTooltip("\u00A7e此外完成探索的时光成就后可在上层世界章节任务获得");
...
<item:goety_revelation:ice_focus>.addTooltip("\u00A7e请勿附魔范围，会导致游戏崩溃");
...
<item:goety_revelation:soul_of_obsidian>.addTooltip("\u00A7c玩家用镐类工具击杀黑曜石巨柱时有几率掉落");
<item:goety_revelation:soul_of_obsidian>.addTooltip("\u00A7e新增可合成获得");

<item:goety_revelation:spider_fang>.addTooltip("\u00A76击杀育母蜘蛛可获得");
<item:goety_revelation:spider_fang>.addTooltip("\u00A7c在下界、阿比斯之渊、死寂之海放置蜘蛛网可转化为蜘蛛之母巢穴");
<item:goety_revelation:spider_fang>.addTooltip("\u00A7e破坏蜘蛛之母巢穴会召唤出育母蜘蛛");
...
//黑曜石之魂
craftingTable.addShaped("goety_revelation.soul_of_obsidian", <item:goety_revelation:soul_of_obsidian>, [[<item:minecraft:crying_obsidian>, <item:bosses_of_mass_destruction:soul_star>, <item:minecraft:crying_obsidian>], [<item:bosses_of_mass_destruction:soul_star>, <item:netherdepthsupgrade:obsidianfish>, <item:bosses_of_mass_destruction:soul_star>], [<item:minecraft:crying_obsidian>, <item:bosses_of_mass_destruction:soul_star>, <item:minecraft:crying_obsidian>]]);

//永恒怀表
<tag:items:curios:necklace>.remove(<item:goety_revelation:eternal_watch>);
<tag:items:curios:time>.add(<item:goety_revelation:eternal_watch>);

//goety-2.5.46.3
/*
<item:goety_revelation:ender_keeper_sword>.addTooltip("\u00A7c待定");
*/
